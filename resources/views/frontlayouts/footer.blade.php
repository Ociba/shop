    ...
    <div class="container">
        ...
        <div class="footer-bottom-cms">
            <div class="footer-payment">
                <ul>
                    <li class="mastero"><a href="#"><img alt="" src="{{asset('front/image/payment/mastero.jpg')}}"></a></li>
                    <li class="visa"><a href="#"><img alt="" src="{{asset('front/image/payment/visa.jpg')}}"></a></li>
                    <li class="currus"><a href="#"><img alt="" src="{{asset('front/image/payment/currus.jpg')}}"></a></li>
