    ...
    <div class="col-sm-9" id="content">
            ...
            <form class="form-horizontal" wire:submit.prevent="saveClientInfo">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Chose One</label>
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" value="2" wire:model="user_type">
                                Accomodation </label>
                            <label class="radio-inline">
                                <input type="radio" checked="checked" value="4" wire:model="user_type">
